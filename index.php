 <?php
    ...
    // Esta parte do código só deve ser executada se o formulário for enviado.
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($feedbackController->submitMessage($message, $nome, $email)) {
            ...
            echo "<script>alert('$sucess'); window.location.href = 'index.php';</script>";
            exit;
        } else {
    ...
    // Se não for POST, o restante do HTML será simplesmente renderizado.
    ?>
