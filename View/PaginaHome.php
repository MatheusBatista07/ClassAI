                ...
                <div class="col-lg-8">
                    ...
                    <section class="profile-card-main mb-4">
                        <div class="profile-intro">
                            <h2 class="user-name">Jeferson Souza</h2>
                        ...
                        <div class="consistency-badge">
                            ...
                            <div>
                                ...
                                <span class="consistency-text">dias de  
Constância</span>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="row g-4 mb-4">
                        <div class="col-md-6">
                            <article class="summary-card">
                                <div class="card-icon-wrapper concluded"><i class="bi bi-mortarboard-fill"></i></div>
                                <div class="summary-info">
                                    <h3 class="summary-title">Cursos Concluídos</h3>
                                    <p class="summary-count">3 Cursos</p>
                                    <a href="#" class="summary-link">veja mais</a>
                                </div>
                            </article>
                        </div>
                        <div class="col-md-6">
                            <article class="summary-card">
                                <div class="card-icon-wrapper in-progress"><i class="bi bi-book-half"></i></div>
                                <div class="summary-info">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <article class="course-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="course-instructor">João Santos</p>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <article class="course-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="course-instructor">João Pedro</p>
                                        <button class="btn btn-enroll w-100">Matricular-me</button>
                                    </div>
                                </article>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                 <article class="course-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="course-instructor">Pedro Carlos</p>
                                        <button class="btn btn-enroll w-100">Matricular-me</button>
                                    </div>
                                </article>
                            </div>
